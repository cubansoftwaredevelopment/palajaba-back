...
class NormalizeCatalogThemeTests(unittest.TestCase):
    ...
    def test_normalizes_case_and_whitespace(self) -> None:
        ...
        self.assertEqual(normalize_catalog_theme(" BLUE "), "blue")
        self.assertEqual(parse_catalog_theme(" BLUE "), "blue")
        self.assertEqual(normalize_catalog_theme(" PURPLE "), "purple")
        ...
        self.assertEqual(normalize_catalog_theme(" CARMELITA "), "carmelita")
        self.assertEqual(parse_catalog_theme(" CARMELITA "), "carmelita")
